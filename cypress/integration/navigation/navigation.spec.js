...
/** Test case for My Trials Link */
When("I click on My Trials", () => {
  cy.contains("My Trials").click();
});

Then("location includes {string}", (url) => {
  cy.url().should("eq", `${url}`);
});
/** Test case for My Trials ends here */

/** Test case for All Trials Link */
When("I click on All Trials", () => {
  cy.contains("All Trials").click();
});
...
Then("location includes {string}", (url) => {
  ...
  cy.document().then((doc) => {
    cy.log(doc.location);
    doc.location = "all-trials";
  });
});
/** Test case for All Trials ends here */

/** Test case for Create New Link */
...
/** Test case for Create New Link ends here */
